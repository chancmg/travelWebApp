...
var data = {
	labels : ["20-7-2016","21-7-2016","22-7-2016","23-7-2016","24-7-2016","25-7-2016","26-7-2016"],
	datasets : [
		{
			label: "Total dataset",
			...
			data: [600, 700, 580, 600, 590, 530, 630]
		},
		{
			label: "On-time dataset",
			...
			pointHighlightFill : "#ffffff",
			pointHighlightStroke : "#ffffff",
			data: [590, 650, 550, 540, 580, 490, 580]
		}
	]
};
    ...
    datasets: [
        {
            ...
            data: [80, 75, 90, 85, 92, 87, 68, 91, 93, 74, 93, 82]
        }
    ]
};
